    ...
    <div id ="addSessionForm" style = "margin: 10px 0px 20px 0px" hidden>
        ...
        <table cellspacing="0" id ="addSessionFormTable">
            ...
            <tr>
                ...
                <td name="date"> <input class="adminTextButton textButtonBorder" name="newDate" id="newDate" type="text"> </td>
                <td name="time"> <input class="adminTextButton textButtonBorder" name="newTime" id="newTime" type="text" required> </td>
                <td style="width: auto">
