...
//        ApplicationContext context = new ClassPathXmlApplicationContext("application-context.xml");
        ...
        HallService hallServiceBean = context.getBean(HallService.class);
        OrderService orderServiceBean = context.getBean(OrderService.class);
        TicketService ticketServiceBean = context.getBean(TicketService.class);
        MovieSessionService sessionsServiceBean = context.getBean(MovieSessionService.class);
