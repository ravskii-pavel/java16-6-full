...
<div class="wrapper">
    ...
    <main class="right-col">
        <section>
            <h1><d:out value="${movieSession.hall.hallName}">  </d:out></h1>
            <br><br>
            ...
            <d:forEach var="row" items="${movieSession.hall.rowList}">
                <d:forEach var="seat" items="${row.seatList}">
                    <div class="switch">
                        <input type="checkbox" id="${row.id}-${seat.id}" class="switch-check">
                        <label for="${row.id}-${seat.id}" class="switch-label">${seat.numberSeat}</label>
                    </div>
                </d:forEach>
            </d:forEach>
        </section>
