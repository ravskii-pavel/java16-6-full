public class Main {
    ...
    /*-----------------------------------------------------------------------------------------*/
    public static String daysOfMonth(int month, int year) {
    ...
    public static String playingCards(int suitCard, int valueCard) {
        ...
        switch (suitCard) {
            case 1:
                return fullNameOfCard + "пик";
            case 2:
                return fullNameOfCard + "треф";
            case 3:
                return fullNameOfCard + "бубен";
            case 4:
                return fullNameOfCard + "червей";
            default:
